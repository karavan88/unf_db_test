...
We wanna measure how the final score of ECDI correlates with its subcomponents. Since all the measures are binary, we used Phi coefficient to measure the correlations as this method suits best for dichotomous measures. 
